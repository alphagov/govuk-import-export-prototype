...
Find out about the [species that are on the CITES list](https://www.gov.uk/cites-controls-import-and-export-of-protected-species).

If your animals are on the list:
...
[Check the list of animals at risk of rabies](https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/427913/guid-rm01a.pdf) to see if the animals you’re importing need a licence to comply with rabies regulations.

If your animals is on the list:
...
- return it to the [Border Inspection Post](http://ec.europa.eu/food/animals/vet-border-control/bip-contacts/index_en.htm) before the consignment is unloaded


### Find a border inspection post

[Check the border inspection post you’re using is approved](http://ec.europa.eu/food/animals/docs/bips_contact_unitedkingdom.pdf) to check the animals or animal products in your shipment.
...
[How much might importers be changed?]
...
You must pay an additional fee of £80 to get a whole or part inspection done at weekends, or any time outside of 8:30am and 5:00pm on weekdays.
...
A permit costs £67 for each type of specimen you import.
