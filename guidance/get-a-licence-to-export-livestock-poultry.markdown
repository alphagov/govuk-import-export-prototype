...
If your consignment will travel through the EU on the way to a non EU country, you may need both an [Intra Trade Animal Health Certificate (ITAHC)](###Exporting live animals within the EU) and an [EHC](###get-an-existing-ehc-issued).
